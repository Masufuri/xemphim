...
?>
    ...
    <?php
        ...
        foreach($layallphim as $se){
            ...
            if(strlen(strstr($se['theloai'],$ctl['theloai'])>0))echo "<div class='divpicnew'><a href='infophim.php?id=".$se['maphim']."'><img class='picnew' src='".$se['picture']."'><br><span class='title-phim-hot'>".$chamchamcham."</span></a></div>";
        }
